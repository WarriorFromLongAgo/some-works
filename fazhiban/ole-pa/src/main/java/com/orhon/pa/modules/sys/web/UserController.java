...
import com.orhon.pa.common.beanvalidator.BeanValidators;
...
import com.orhon.pa.common.utils.excel.ImportExcel;
...
public class UserController extends BaseController {
	...
	@RequiresPermissions("user")
	@ResponseBody
	@RequestMapping(value = "treeDataAssign")
	public List<Map<String, Object>> treeDataAssign(@RequestParam(required=false) String officeId, HttpServletResponse response) {
		List<Map<String, Object>> mapList = Lists.newArrayList();
		List<User> list = systemService.findUserByOfficeId(officeId);
		for (int i=0; i<list.size(); i++){
			User e = list.get(i);
