...
import com.orhon.pa.modules.sys.service.AreaService;
import com.orhon.pa.modules.sys.service.OfficeService;
...
//		}
	 ...
	 * 获取机构JSON数据。
	 * @param extId 排除的ID
	 * @param type	类型（1：机关；2：部门/小组/其它：3：用户）
	 * @param grade 显示级别
	 * @param response
	 * @return
	 */
