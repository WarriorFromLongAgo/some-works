 ...
 */
package com.orhon.pa.modules.act.service.ext;
...
import com.orhon.pa.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.orhon.pa.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.orhon.pa.modules.sys.entity.User(null, userId)))){
