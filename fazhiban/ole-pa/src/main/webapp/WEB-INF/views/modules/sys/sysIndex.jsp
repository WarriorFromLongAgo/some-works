...
<html>
<head>
	<title>呼和浩特市行政执法监督平台-绩效考核系统</title>
	...
	<style type="text/css">
		...
		.navbar-inner {
			    ...
			    background-image: -webkit-gradient(linear,0 0,0 100%,from(#3c8dbc),to(#3c8dbc));
			    ...
			    border-radius: 4px;
			    filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#3c8dbc',endColorstr='#ff2fa4e7',GradientType=0);
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="brand"   style="height:30px;"><img src="static/images/logoNew.png"><span style="margin-left:15px;font-size: 24lpx;" id="productName">绩效考核系统</span></div>
				<ul id="userControl" class="nav pull-right">
					<!-- <li><a href="wz-index.html" target="_blank" title="访问网站主页"><i class="icon-home"></i></a></li> -->
...
<%-- 							<c:forEach items="${fns:getDictList('theme')}" var="dict"><li><a href="#" onclick="location='${pageContext.request.contextPath}/theme/${dict.value}?url='+location.href">${dict.label}</a></li></c:forEach>
 --%>							<li><a href="javascript:cookie('tabmode','${tabmode eq '1' ? '0' : '1'}');location=location.href">${tabmode eq '1' ? '关闭' : '开启'}页签模式</a></li>
					...
					<li><a href="#"    onclick="CloseWebPage()"  title="关闭">关闭</a></li>
					<li>&nbsp;</li>
				</ul>
				<div class="nav-collapse">
					<ul id="menu" class="nav" style="*white-space:nowrap;float:none;">
						...
						<c:forEach items="${fns:getMenuList()}" var="menu" varStatus="idxStatus">
							<c:if test="${menu.parent.id eq '186'}">
	    ...
	    <div class="container-fluid">
		    ...
		    <!-- <div id="footer" class="row-fluid">
	            Copyright &copy; 2010-2018 绩效考核系统- <a href="http://www.orhonit.com/" target="_blank">内蒙古奥尔弘科技有限公司</a>
			</div> -->
		</div>
	</div>
	<script type="text/javascript"> 
