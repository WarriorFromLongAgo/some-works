...
<%-- 		<div class="control-group">
		...
		<div class="form-actions">
			<c:if test="${(opaSchemeItem.status eq fns:getDictValue('待填报','opa_schemeItem_status','')) or (opaSchemeItem.status eq fns:getDictValue('待填报','opa_schemeItem_status','')) or (opaSchemeItem.status eq fns:getDictValue('填报已退回','opa_schemeItem_status',''))}">
