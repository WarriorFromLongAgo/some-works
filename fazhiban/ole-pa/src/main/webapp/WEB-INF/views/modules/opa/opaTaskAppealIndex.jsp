...
<head>
	...
	<script type="text/javascript">
		...
		function btnRender(row){
			var str="";
			if((row.status == "${fns:getDictValue('申诉中', 'opa_taskAppeal_status', '')}")
					||(row.status == "${fns:getDictValue('已退回', 'opa_taskAppeal_status', '')}")){
					str+="<shiro:hasPermission name='pa:opaTaskAppeal:edit'><a href='${ctx}/opa/opaTaskAppeal/inputScore?id="+row.id 
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/opa/opaTaskAppeal/index">评分申诉</a></li>
	<%-- 	<shiro:hasPermission name="pa:opaTaskAppeal:edit">
		<li>
