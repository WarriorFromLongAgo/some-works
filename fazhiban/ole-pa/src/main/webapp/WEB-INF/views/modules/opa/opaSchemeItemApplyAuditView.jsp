...
<body>
	<ul class="nav nav-tabs">
			<li class="active"><a href="${ctx}/opa/opaSchemeItem/apply/batch/view?id=${opaSchemeItem.id}">方案指标填报</a></li>
	
	</ul>
	<form:form id="inputForm" modelAttribute="opaSchemeItem" action="${ctx}/opa/opaSchemeItem/apply/batch/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="count" htmlEscape="false" class="input-mini  number"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">考评标准：</label>
			<div class="controls">
				<form:input path="value" htmlEscape="false" class="input-mini  number"/><span class="help-inline">分</span>
			</div>
		</div>
