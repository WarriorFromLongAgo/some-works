...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/opa/opaScheme/form?id=${opaScheme.id}">考核方案<shiro:hasPermission name="pa:opaScheme:edit">${not empty opaScheme.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="pa:opaScheme:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="opaScheme" action="${ctx}/opa/opaScheme/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			...
			<%-- <shiro:hasPermission name="pa:opaScheme:apply"><input id="btnApply" class="btn btn-primary" type="button" value="提交" onclick="return confirmx('确认要提交该考核方案吗？', apply)"/>&nbsp;</shiro:hasPermission> --%>
