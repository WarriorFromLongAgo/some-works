...
public class SsoRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
		...
		//设置菜单
		List<Permission>   list = permissionService.getOwnMenuByUserIdAndSysId(user.getId(), SystemConstants.PERMISSION_ID_ENFORCE.getCode().toString());
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		List<Permission> permissionList = SpringContext.getBean(PermissionDao.class).listModuleMenuByUserId(user.getId(), SystemConstants.PERMISSION_ID_ENFORCE.getCode().toString());
