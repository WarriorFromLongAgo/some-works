...
@ControllerAdvice
public class EnforceExceptionHandlerAdvice {

	@ExceptionHandler({ IllegalArgumentException.class })
	@ResponseBody
	@ResponseStatus(HttpStatus.BAD_REQUEST)
	public ResponseInfo badRequestException(IllegalArgumentException exception) {
		return ResponseInfo.builder().code(HttpStatus.BAD_REQUEST.value() + "").msg(exception.getMessage()).build();
	}
	...
	public ResponseInfo loginException(Exception exception) {
		return ResponseInfo.builder().code(HttpStatus.UNAUTHORIZED.value() + "").msg(exception.getMessage())
				.build();
	}
	...
	public ResponseInfo forbidden(Exception exception) {
		return ResponseInfo.builder().code(HttpStatus.FORBIDDEN.value() + "").msg(exception.getMessage()).build();
	}
	...
	@ExceptionHandler(EnforceException.class)
	@ResponseBody
	@ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
	public ResponseInfo enforceException(EnforceException enforceException) {
		log.error("系统异常", enforceException);
		return ResponseInfo.builder().code(enforceException.getCode() + "")
				.msg(enforceException.getMessage()).build();
	...
	public ResponseInfo exception(Throwable throwable) {
		...
		return ResponseInfo.builder().code(HttpStatus.INTERNAL_SERVER_ERROR.value() + "")
				.msg(throwable.getMessage()).build();
