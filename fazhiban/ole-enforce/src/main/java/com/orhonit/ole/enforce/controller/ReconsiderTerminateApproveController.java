 ...
 */
@RestController
@RequestMapping("/reconsiderTerminateApprove")
public class ReconsiderTerminateApproveController{
	...
	public TableResponse<CaseListDTO> listCase(TableRequest request) {
		...
		request.getParams().put("caseStatus", CommonParameters.CaseStatus.ZZFYSP);
