 ...
 */
@RestController
@RequestMapping("/reconsiderCommandApprove")
public class ReconsiderCommandApproveController{
	...
	public TableResponse<CaseListDTO> listCase(TableRequest request) {
		...
		request.getParams().put("caseStatus", CommonParameters.CaseStatus.ZLHFSP);
