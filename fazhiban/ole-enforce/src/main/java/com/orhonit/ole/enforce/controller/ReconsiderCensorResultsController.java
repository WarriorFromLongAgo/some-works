 ...
 */
@RestController
@RequestMapping("/reconsiderCensorResults")
public class ReconsiderCensorResultsController{
	...
	public TableResponse<CaseListDTO> listCase(TableRequest request) {
		...
		request.getParams().put("caseStatus", CommonParameters.CaseStatus.HCJGXD);
