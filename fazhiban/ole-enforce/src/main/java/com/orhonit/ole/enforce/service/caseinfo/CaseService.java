package com.orhonit.ole.enforce.service.caseinfo;
...
public interface CaseService {
	...
	ApiCountDTO caseSubmitCount(Map<String, Object> params);
	ApiCountDTO caseSubmitCount(String id);
//	ApiCountDTO caseSubmitCountOld(String id);
	...
	PageList<PsCheckDTO> ApiSelectSpecialBydeptIdMap(PsCheckDTO caseDTO);
	/**
	 * API
	 * 根据deptId查询一般案件列表
	 * @param 
	 ...
	 * @return PsCaseDTO
	 */
	PageList<PsCaseDTO> caseAllListMap(PsCaseDTO caseDTO);
	...
	Integer checkQueryCount(Map<String, Object> params);
  
	  PageList<LssuedEntity> checkQueryList(Map<String, Object> params);
  
	  Integer getCheckDailyCount(Map<String, Object> params);
  
	  PageList<CheckDailyDTO> getCheckDailyList(Map<String, Object> params);
	 ...
	 * @return
	 */
	List<PsCaseDTO> generalCaseDept(Map<String, Object> params);
	/**
	 * API
	 * 简易案件统计分区域
	 * @param params
	...
	ApiCaseInfoDTO findCaseByCaseNum(String caseNum);
	 ...
	 * 权责列表查询统计
	 */
	Integer selectPotenceListBydeptIdCount(Map<String, Object> plMap);

	Integer getQueryCasecount(Map<String, Object> params);
	
	Integer getQueryCasecountApp(Map<String, Object> params);

	List<CaseListDTO> getQueryCaseList(Map<String, Object> params, Integer start, Integer length);
	
	PageList<CaseListDTO> getQueryCaseListApp(Map<String, Object> params);
	 ...
	 * @return 
	 */
	CaseEntity updateWqToZzf(CaseEntity caseEntity);
	...
	int getLeaderCaseCount(PersonAppDTO personAppDTO,String caseStatusList);
	 ...
	 * APP 日常检查案件
	 * **/
	ApiDailyCheckDTO getDailyByCaseId(Map<String, Object> caseIdMp);
	/**
	 * APP 专项检查案件
	 * **/
	LssuedDetailInfoDTO getSpecialByCaseId(Map<String, Object> caseIdMp);
...
Integer yujCountApp(Map<String, Object> params);
	/**
	 * 生成案件编号
	 * @return
	 */
	 ...
	 * @return
	 */
	FlowDTO saveShare(CaseEntity caseEntity, User user);
	
	/**
	 * ps
	 * 权责列表查询统计
	 */
//	int selectPotenceListBydeptIdCount(Map<String, Object> plMap);
}
