 ...
 */
@RestController
@RequestMapping("/reconsiderCommandNotify")
public class ReconsiderCommandNotifyController{
	...
	public TableResponse<CaseListDTO> listCase(TableRequest request) {
		...
		request.getParams().put("caseStatus", CommonParameters.CaseStatus.ZLHFTZ);
