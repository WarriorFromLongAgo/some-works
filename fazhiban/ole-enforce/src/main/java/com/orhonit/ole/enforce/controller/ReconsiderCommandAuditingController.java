 ...
 */
@RestController
@RequestMapping("/reconsiderCommandAuditing")
public class ReconsiderCommandAuditingController{
	...
	public TableResponse<CaseListDTO> listCase(TableRequest request) {
		...
		request.getParams().put("caseStatus", CommonParameters.CaseStatus.ZLHFSH);
