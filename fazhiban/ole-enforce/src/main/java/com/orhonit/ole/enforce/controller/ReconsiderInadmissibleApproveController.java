 ...
 */
@RestController
@RequestMapping("/reconsiderInadmissibleApprove")
public class ReconsiderInadmissibleApproveController{
	...
	public TableResponse<CaseListDTO> listCase(TableRequest request) {
		...
		request.getParams().put("caseStatus", CommonParameters.CaseStatus.BYSLSQ);
