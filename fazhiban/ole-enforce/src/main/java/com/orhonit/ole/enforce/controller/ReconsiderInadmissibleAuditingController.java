 ...
 */
@RestController
@RequestMapping("/reconsiderInadmissibleAuditing")
public class ReconsiderInadmissibleAuditingController{
	...
	public TableResponse<CaseListDTO> listCase(TableRequest request) {
		...
		request.getParams().put("caseStatus", CommonParameters.CaseStatus.BYSLSH);
