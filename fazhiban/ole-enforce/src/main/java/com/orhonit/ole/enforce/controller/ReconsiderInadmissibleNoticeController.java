 ...
 */
@RestController
@RequestMapping("/reconsiderInadmissibleNotice")
public class ReconsiderInadmissibleNoticeController{
	...
	public TableResponse<CaseListDTO> listCase(TableRequest request) {
		...
		request.getParams().put("caseStatus", CommonParameters.CaseStatus.BYSLTZ);
