...
import com.orhonit.ole.enforce.filter.LogoutFilter;
...
public class ShiroConfiguration {
	...
	public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
		...
		filterChainDefinitionMap.put("/shareapi/user/login/**", "anon");
		...
		filterChainDefinitionMap.put("/shareapi/**", "anon");
		...
		logoutFilter.setRedirectUrl("/enforce/login.html");
