 ...
 *
 */
@Component("checkDealTask")
@Slf4j
public class CheckDealTask {
	...
	public void checkTask(String params){
		...
		for (Map<String, Object> item : result) {
			...
			//获取需要发送的执法人员和相关信息列表
			List<WarnPersonEntity> warnPersonEntitys= taskService.getPersonListByCheckNum(item.get("caseNum").toString(), ruleDto.getRoleId());
