...
public class CheckDailyController {
	...
	public Result<CheckDailyDTO> queryById(@PathVariable String checkId) {
		...
		CheckDailyDTO dto = this.checkDailyService.queryCheckById(checkId,params);
	 ...
	 * @return
	 */
	@GetMapping("/queryCheckId/{checkId}")
