...
public interface CaseDao {
	 ...
	 * @return
	 */
	public int ApiDailyNum(PsCheckDTO caseDTO);
	...
	Map<String, Integer> getLeaderCaseCount(@Param("personAppDTO") PersonAppDTO personAppDTO,
	...
	@Update("UPDATE ole_ef_case ce SET ce.is_ps=#{isps}WHERE ce.case_num =#{id}")
	void updateCaseIsps(@Param("id") String id, @Param("isps") String isps);
	 ...
	 * @return
	 */
	PsCheckDTO getDailyByCaseId(@Param("caseIdMp") Map<String, Object> caseIdMp);
	 ...
	 * @return
	 */
	PsCheckDTO getSpecialByCaseId(@Param("caseIdMp") Map<String, Object> caseIdMp);
	 ...
	 * @return
	 */
	@Select("SELECT ec.case_num caseNum,ec.case_name caseName,ec.case_source caseSource,ec.case_address caseAddress,ec.case_zzfryname caseZzfryname,ec.lng,ec.lat FROM ole_ef_case ec WHERE lng<>''")
