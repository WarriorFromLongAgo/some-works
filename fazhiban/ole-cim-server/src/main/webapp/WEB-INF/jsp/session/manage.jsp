...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>CIM管理系统</title>
		<link charset="utf-8" rel="stylesheet" 	href="<%=basePath%>/bootstrap-3.3.6-dist/css/bootstrap.min.css" />
		<link charset="utf-8" rel="stylesheet" href="<%=basePath%>/css/base-ui.css" />
		<script type="text/javascript" 	src="<%=basePath%>/js/jquery-2.2.3.min.js"></script>
		<script type="text/javascript" src="<%=basePath%>/bootstrap-3.3.6-dist/js/bootstrap.min.js"></script>
		 ...
		 function doSendMessage()
		  {
		    ...
		    $.post("<%=basePath%>/message/send", {msg:message,username:account,messageType:2,mid:account},
			   function(data){
		  ...
		  function onImageError(obj)
			{
			    obj.src="<%=basePath%>/img/icon.png";   
			}
			
		  function  openWebclient(){
		     window.open ("<%=basePath%>/msgindex/main", "","height="+500+", width="+600+", top=0, left=0, toolbar=no,menubar=no, scrollbars=no, resizable=no,location=no, status=no");
		  }
		</script>
	</head>
	<body class="web-app ui-selectable">
		...
		<div class="lay-main-toolbar">
				...
				<div>
					<form action="<%=basePath%>/msgindex/list" method="post"
