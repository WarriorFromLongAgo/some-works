...
public class MessageDispatcher {
	...
	public static void main(String[] args) {
		...
		msg.setReceiver("111111");
		msg.setMid("75c71b912dc24e2bb7a9eca0f531c2d9");
		msg.setContent("您有一个案件需要审批");
		msg.setReceiver("150100102455");
		msg.setFormat("CF-150100102455");
		msg.setAction("action");
		try {
			MessageDispatcher.httpPost("http://111.235.156.244:8087/cim/message/push/send", msg);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
