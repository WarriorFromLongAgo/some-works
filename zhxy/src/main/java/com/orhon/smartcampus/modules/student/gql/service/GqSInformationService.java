package com.orhon.smartcampus.modules.student.gql.service;
...
import com.orhon.smartcampus.modules.student.gql.fetcher.GqSInformationBaseFetcher;
...
//@Service
public class GqSInformationService extends GraphqlService {
    ...
    protected String[] getSchema() {
        return new String[]{SCHEMA_ROOT,SCHEMA_USER};
    }

    //@Override
    protected RuntimeWiring buildDynamicRuntimeWiring() {
        RuntimeWiring.Builder builder = RuntimeWiring.newRuntimeWiring();
        builder.type(TYPE_QUERY , typeWiring-> typeWiring.dataFetcher("student" , new StaticDataFetcher("world2")));
