...
import com.orhonit.modules.generator.redis.SysConfigRedis;
import com.orhonit.modules.sys.dao.SysConfigDao;
import com.orhonit.modules.sys.entity.SysConfigEntity;
...
public class SysConfigServiceImpl extends ServiceImpl<SysConfigDao, SysConfigEntity> implements SysConfigService {
	...
	public PageUtils queryPage(Map<String, Object> params) {
		...
		page.setTotal(this.selectCount(new EntityWrapper<SysConfigEntity>().like(StringUtils.isNotBlank(paramKey),"param_key", paramKey)
				.eq("status", 1)));
